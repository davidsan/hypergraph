...
/**
 * Servlet implementation class CreateFriendship
 */
public class CreateFriendshipServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        JSONObject json = FriendshipsServices.createFriendship(token,
                requesteeId);
        out.print(json);
    }
